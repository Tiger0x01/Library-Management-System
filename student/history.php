...
<html lang="en">
    <head>
        ...
        <title>Borrow History - Modern LMS</title>
        ...
        .search-input {
            ...
            border: 1px solid #e9ecef; border-right: none;
        ...
        <div class="wrapper">
            <nav id="sidebar">
                ...
                <ul class="list-unstyled components">
                    ...
                    <li>
                        <a href="book.php"><i class="bi bi-journal-album"></i>
                            All Books</a>
                    </li>
                    <li class="active">
                        <a href="history.php"><i
                                class="bi bi-clock-history"></i> Borrow
                            History</a>
                    </li>
                    <li>
                        <a href="current.php"><i class="bi bi-list-check"></i>
                            Currently Issued</a>
                    </li>
                    <li class="mt-5 border-top pt-3">
                        <a href="logout.php" class="text-danger fw-bold"><i
            ...
            <div id="content">
                <nav
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <h5 class="fw-bold mb-0 text-dark">Borrowing
                            History</h5>
                    </div>
                    <div class="d-flex align-items-center">
                ...
                <div class="search-card">
                    <form action="history.php" method="post" class="mb-0">
                        <div class="row align-items-center">
                            <div class="col-md-8 offset-md-2">
                                <label
                                    class="form-label fw-semibold text-muted ms-2 mb-2">Search
                                    your past records:</label>
                ...
                <div class="custom-table-container">
                    ...
                    $sql =
                    "SELECT * FROM LMS.record, LMS.book WHERE RollNo = '$rollno' AND Date_of_Issue IS NOT NULL AND Date_of_Return IS NOT NULL AND book.Bookid = record.BookId AND (record.BookId='$s' OR Title LIKE '%$s%') ORDER BY Date_of_Return DESC";

                    echo "<p class='text-muted mb-4'>Showing results for:
                    ...
                    $sql =
                    "SELECT * FROM LMS.record, LMS.book WHERE RollNo = '$rollno' AND Date_of_Issue IS NOT NULL AND Date_of_Return IS NOT NULL AND book.Bookid = record.BookId ORDER BY Date_of_Return DESC";
                    }
                        ...
                        <table class="table table-borderless align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><i
                                            class="bi bi-calendar-event text-muted me-2"></i><?php
                                        echo date('d M Y',
                                        strtotime($issuedate)); ?></td>
                                    <td><i
                                            class="bi bi-calendar-check text-muted me-2"></i><?php
                                        echo date('d M Y',
                                        strtotime($returndate)); ?></td>
                                    <td>
                                        <span
                    ...
                    <div class="empty-state">
                        ...
                        <p class="text-muted">You haven't borrowed any books
                            yet, or no books match your search.</p>
                        <a href="book.php"
                            class="btn btn-outline-primary rounded-pill px-4 mt-2">Browse
                            Library</a>
                    </div>
                    <?php } ?>
                </div>
