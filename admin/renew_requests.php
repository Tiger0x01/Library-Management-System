...
<head>
    ...
    <title>Renew Requests - Librarian Portal</title>
    ...
    <style>
        ...
        /* ===== Components ===== */
        .roll-badge {
            background: #eef0f8; color: var(--primary); font-weight: 700;
            padding: 8px 15px; border-radius: 10px; font-size: 0.85rem; display: inline-block;
        }
        .renewal-count {
            display: inline-flex; align-items: center; justify-content: center;
            width: 35px; height: 35px; border-radius: 50%;
            background: rgba(255, 184, 0, 0.1); color: var(--accent);
            font-weight: 700; border: 2px solid rgba(255, 184, 0, 0.2);
        }
        ...
        .btn-approve:hover { background: #27ae60; box-shadow: 0 5px 15px rgba(46, 204, 113, 0.3); transform: scale(1.03); color: white; }
    ...
    <div id="content">
        <nav class="top-navbar d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                ...
                <h5 class="fw-bold mb-0 text-dark">Renewal Approvals</h5>
            </div>
        ...
        <div class="text-center">
            <div class="request-nav">
                ...
                <a href="renew_requests.php" class="nav-btn active">Renew Requests</a>
        ...
        <div class="custom-table-card">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h5 class="fw-bold mb-0"><i class="bi bi-arrow-repeat text-primary me-2"></i> Pending Renewals</h5>
                <span class="badge bg-soft-primary text-primary px-3 py-2 rounded-pill" style="background: rgba(93,99,212,0.1)">Real-time Request Hub</span>
            </div>

            <?php
            $sql = "SELECT renew.BookId, renew.RollNo, Title, Renewals_left 
                    FROM LMS.renew, LMS.book, LMS.record 
                    ...
                    <table class="table table-borderless align-middle">
                        <thead>
                            <tr>
                                ...
                                <th>Book ID</th>
                                <th>Book Title</th>
                                <th class="text-center">Tries Left</th>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <small class="text-muted">Digital Record</small>
                                    </td>
                                    <td class="text-center">
                                        <div class="renewal-count"><?php echo $renewals; ?></div>
                                    </td>
                                    <td class="text-end">
                                        <?php if($renewals > 0): ?>
                                            <a href="acceptrenewal.php?id1=<?php echo $bid; ?>&id2=<?php echo $rno; ?>" class="btn btn-approve shadow-sm">
            ...
            <?php 
                ...
                echo '<div class="empty-state">
                        <i class="bi bi-cloud-check opacity-25"></i>
                        <h5 class="fw-bold mt-3 text-muted">No Pending Renewals</h5>
                        <p class="text-muted">Students are all set! No renewal requests waiting.</p>
                      </div>';
            }
            ?>
        </div>
